...
def main(argparse_args):
    ...
    pipeline = pipeutil.create(pipeline_meta, "capriqorn.preproc")

    pipeutil.check_dependencies(pipeline, "capriqorn.preproc_all")
    pipeutil.check_conflicts(pipeline, "capriqorn.preproc_all")
